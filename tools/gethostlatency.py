...
b = BPF(text=bpf_text)
b.attach_uprobe(name=args.obj, sym="getaddrinfo", fn_name="do_entry", pid=args.pid)
b.attach_uprobe(name=args.obj, sym="gethostbyname", fn_name="do_entry",
                pid=args.pid)
b.attach_uprobe(name=args.obj, sym="gethostbyname2", fn_name="do_entry",
                pid=args.pid)
b.attach_uretprobe(name=args.obj, sym="getaddrinfo", fn_name="do_return",
                   pid=args.pid)
b.attach_uretprobe(name=args.obj, sym="gethostbyname", fn_name="do_return",
                   pid=args.pid)
b.attach_uretprobe(name=args.obj, sym="gethostbyname2", fn_name="do_return",
                   pid=args.pid)
